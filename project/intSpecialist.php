            ...
            <div class="mainSection__wrapper">
                    <div class="ticketInformation__container">
                        ...
                        <div class="ticket__information">
                            ...
                            <input id="operator-name" type="text"
                            list="operators" class="edit-field" autocomplete="off" value="" readonly>
                            ...
                            <input type="text" id="operating-system" class="edit-field" list="operating-systems" value="" readonly>
                            ...
                            <input type="text" id="problem-type" class="edit-field" list="problem-types" value="">  
                            ...
                            <input id="close-time" name="close-time" class="closed__field no-edit-field" type="text" value="">
                            
                        </div>

                        <div class="ticket_history_section">
                            <button class="info-edit-btn" id="ticket_history_btn" onclick='displayTicketHistory()'>Show Past Edit(s)</button>
                            <div class="ticket_history_container" id="ticket_history_body" style = "display:none;"></div>
                        </div>

                        <div class="solution_history_section">
                        <button class="info-edit-btn" id="solution_history_btn" onclick='displaySolutionHistory()'>Show Solution History</button>
                ...
                <div class="closeForm__wrapper tile">
                    ...
                    <div class="solution__wrapper">
                        <div class="topSolution__section">    
                            ...
                            <div class="solution_button_wrapper">
                                ...
                                <div class="solution__buttons discard-solution">
                                    <button type="button" class="form-btn" id="dropSolution-btn">Discard Solution</button>
                                </div>
                        ...
                        <div class="previous-fixes-header pf-head1">
                                        ...
                                        <button type="button" class="form-btn" id="goback-btn"><i class="fas fa-arrow-left"></i></button>
                                        ...
                                        <button type="button" class="previous-fixes-filter problem-type-filter">Problem Type</button>
                        </div>
                        <div class="solutionArea__section">
                            <div class="solutionInput__wrapper">
                                <textarea name="solution" id="solution-area" maxlength = "500" cols="60" rows="10" placeholder="Type solution..."></textarea>
                                <!-- Previous Fixes -->
                            ...
                            <div class="dropSolution__section">
                                <div class="checkbox__section"> 
                                    <label class="checkbox__container">Caller has been given the solution
                                        ...
                                        <span class="checkmark unchecked"><i id="check-state" class="fas fa-check"></i></span>
                                    </label> 
                                </div>
